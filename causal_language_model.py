...
class EOPreTrainer(pl.LightningModule):
...
def cli_main():
    ...
    parser.add_argument('--train_file', type=str,
                        default="data/pretraining/agg_data_train.pkl")
    parser.add_argument('--validation_file', type=str,
                        default="data/pretraining/agg_data_valid.pkl")
